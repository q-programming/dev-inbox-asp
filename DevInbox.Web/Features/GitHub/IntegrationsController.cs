...
/// <summary>
/// Handles integration connection endpoints — currently GitHub PAT connect/disconnect.
/// The OAuth App flow is handled by <see cref="Identity.UserController"/> since it's tied to login.
/// </summary>
